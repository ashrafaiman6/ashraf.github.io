...
const nav = document.querySelector(".item-navbar"),
...
function validateName(){
    ...
    if(!name.match(/^[a-zA-Z]{3,}(?: [a-zA-Z]+){0,2}$/)){
        alert("Nice try. Write your real name");
        return false;
    }
...
function validateEmail(){
    ...
    if(!name.match(/^[A-Za-z\.\-[0,9]*[@][A-Za-z]*[\.][a-z]{2,4}$/)){
        alert("Your email will let you down");
        return false;
    }
...
function validateForm(){
    if(!validateName() || !validateEmail()){
        ...
        submitted=true;
        var thankyou='you gave me the right info. Thanks';
